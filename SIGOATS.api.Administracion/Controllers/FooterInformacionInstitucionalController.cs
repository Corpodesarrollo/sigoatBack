...
{
    public class FooterInformacionInstitucionalController(FooterInformacionInstitucionalRepo repo) : GenericController<FooterInformacionInstitucional, FooterInformacionInstitucionalDto>(repo)
    {
        [HttpGet("GetImg/{id}")]
